...
- **Writes:** Google Calendar · TickTick (per-quarter review lists) · SQLite `earnings_events.db` (schema v13) · Slack `#earnings` (results/digest) + `#status-reports` (date-disagreement alerts) · `exports/upcoming_events.json`
